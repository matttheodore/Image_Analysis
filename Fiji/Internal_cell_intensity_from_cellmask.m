...
%    in order to reduce noise caused by slide/slide mounting media/ or
%    other conditions.
...
% 
%--------------------------------------------------------------------------
% Please refer to MATLAB's documentation and Oufti's user manual for more
% information regarding specific matlab functions.
%--------------------------------------------------------------------------
